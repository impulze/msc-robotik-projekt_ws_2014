...
inline Coord2D catmullRomImpl(double matrix[4][4], float t, Coord2D const &c1, Coord2D const &c2, Coord2D const &c3, Coord2D const &c4)
{
...
inline Coord2D catmullRomFirst(float t, Coord2D const &c1, Coord2D const &c2, Coord2D const &c3)
{
	double matrix[4][4] = {
		{ 0, 2, 0, 0 },
		{ 2, 0, 0, 0 },
...
inline Coord2D catmullRom(float t, Coord2D const &c1, Coord2D const &c2, Coord2D const &c3, Coord2D const &c4)
{
	double a = 1;
...
inline Coord2D catmullRomLast(float t, Coord2D const &c1, Coord2D const &c2, Coord2D const &c3)
{
	double matrix[4][4] = {
		{ 0, 2, 0, 0 },
		{ -1, 0, 1, 0 },
